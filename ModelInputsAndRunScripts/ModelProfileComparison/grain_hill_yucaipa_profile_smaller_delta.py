...
params['disturbance_rate'] = 0.000833
params['uplift_interval'] = 278.0
params['weathering_rate'] = 0.00267
...
plot_hill(gh.grid, 'grain_hill_yucaipa_delta075_d000833.png')
plot_hill(gh.grid, 'grain_hill_yucaipa_delta075_d000833.pdf')
